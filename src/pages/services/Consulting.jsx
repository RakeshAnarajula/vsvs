  ...
  return (
    <div className="bg-gray-100 min-h-screen px-4 md:px-20 py-2 text-gray-800 space-y-6">
      ...
      >
        {[
          { 
            icon: <img src="/Friendly Environment.png" alt="Expert Advisory" />, 
            title: "Expert Advisory", 
            desc: "Industry veterans guiding your SAP journey." 
          },
          { 
            icon: <img src="/End-to-End Services.png" alt="End-to-End Services" />, 
            title: "End-to-End Services", 
            desc: "From assessment to post-go-live support." 
          },
          { 
            icon: <img src="/Business Aligned.png" alt="Business Aligned" />, 
            title: "Business Aligned", 
            desc: "Solutions tailored to your company's growth goals." 
          },
          { 
            icon: <img src="/Innovation Driven.png" alt="Innovation Driven" />, 
            title: "Innovation Driven", 
            desc: "Stay ahead with the latest SAP technologies." 
          },
        ].map((item, idx) => (
          <motion.div
            key={idx}
