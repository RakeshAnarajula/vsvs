...
//       >
//         <h2 className="text-3xl font-bold text-blue-900 text-center mb-10">Why Choose Us</h2>
...
//           />
//           <ul className="md:w-1/2 space-y-4 text-lg text-gray-700 list-disc pl-5">
//             <li>✔️ We have SAP expertises</li>
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          <img
            ...
            className="rounded-xl shadow-md w-full md:w-1/2 object-cover h-64 md:h-80"
          />
         <ul className="md:w-1/2 space-y-4 text-lg  pl-5">
